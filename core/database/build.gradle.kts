...
private val excludedFiles = mutableSetOf(
    "**/co.yml.coreui/core/database/model/*",
    "**/co.yml.coreui/core/database/di/*",
    "**/co.yml.coreui/core/database/dao/*",
    "**/co.yml.coreui/core/database/room/AppDataBase_Impl*.*",
    "**/co.yml.coreui/core/database/Constants.*"
)
...
android {
    namespace = "co.yml.coreui.database"
}
